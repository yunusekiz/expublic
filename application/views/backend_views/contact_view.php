				...
				<h3> <font style="margin-left:290px;">İletişim Bilgilerini Düzenleme Formu</font></h3>
           		...
           		<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="1">                 
						...
						<form action="{base}backend/contact/controlContact" method="post" enctype="multipart/form-data" >
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->											
								...
								<p>
									...
									<input class="text-input large-input" type="text" style="color:black" id="large-input" name="facebook_field" value="{facebook}" />
								</p>
									
								</br>																							
								<p>
									<label> Twitter  </label>
									<input class="text-input large-input" type="text" style="color:black" id="large-input" name="twitter_field" value="{twitter}" />
								</p>							
